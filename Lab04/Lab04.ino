...
void loop()
{
  int rightTracker=digitalRead(ci_Right_Line_Tracker_LED);
int leftTracker=digitalRead(ci_Left_Line_Tracker_LED);
int midTracker=digitalRead(ci_Middle_Line_Tracker_LED);
    ...
    case 0:    //Robot stopped
      {
        readLineTrackers();
        Ping();
        servo_LeftMotor.writeMicroseconds(ci_Motor_Stop);
        servo_RightMotor.writeMicroseconds(ci_Motor_Stop);
